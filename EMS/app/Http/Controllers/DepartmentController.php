...
class DepartmentController extends Controller
{
    ...
    public function show_users_of_dep($dep_id)
    {

        $department = Department::where('id', $dep_id)->get()[0];
        $users = User::where('id_dep', $dep_id)->get();

        return view('departments.show_users_of_dep', compact(['department', 'users']));
    }
    ...
    public function treeView()
    {
        ...
        return view('departments.depTreeview', compact(['tree', 'departments']));
    }
